...
class crossManagerHybridauthItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('crossmanagerhybridauth_item_err_ns');
        }
...
return 'crossManagerHybridauthItemUpdateProcessor';
