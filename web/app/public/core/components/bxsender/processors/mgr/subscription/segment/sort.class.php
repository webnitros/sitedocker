<?php
class bxSegmentSortProcessor extends modObjectProcessor
{
    ...
    /**
     * @param bxSegment $source
     * @param bxSegment $target
     *
     * @return array|string
     */
    public function sort(bxSegment $source, bxSegment $target)
    {
